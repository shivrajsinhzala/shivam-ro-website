          ...
          <div className="product-info-section">
            ...
            <div className="action-buttons-detail">
              ...
              <div style={{ display: "flex", gap: "10px", marginTop: "12px" }}>
                ...
                >
                  <Phone size={18} />
                  <span>Call Dilipbhai</span>
                </a>
                <button
                  type="button"
                  onClick={handleShare}
                  className="btn btn-outline btn-lg"
                  style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "8px", background: copied ? "rgba(34, 197, 94, 0.1)" : "transparent", borderColor: copied ? "#22c55e" : undefined, color: copied ? "#16a34a" : undefined }}
