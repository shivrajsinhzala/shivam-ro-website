      ...
      <div className="container">
        <div className="section-header text-center">
          ...
          <p className="section-desc">
            Browse through our premium water purifier models. Click any product to view its detailed specifications and request a custom quote.
          </p>
        </div>
          ...
          {filteredProducts.length === 0 && (
            <div className="no-results" style={{ gridColumn: "1/-1", textAlign: "center", padding: "60px 20px" }}>
              ...
              <p style={{ color: "var(--text-light-3)", marginTop: "8px" }}>
                There are no purifiers in this category. Click &quot;View Full Products Catalog&quot; to browse all available options.
              </p>
            </div>
          )}
        </div>
        ...
        <div className="explore-products-btn">
          <Link href="/products" className="btn btn-primary btn-lg">
            View Full Products Catalog &rarr;
          </Link>
        </div>
      </div>
    </section>
