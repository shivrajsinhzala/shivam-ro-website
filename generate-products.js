...
// 1. Load products database from products.json
...
function getProductHTML(product) {
  ...
  const waEnMsg = `Hi Shivam Water Solution, I am interested in a price quote for the ${product.name} water purifier model.`;
  const waUrl = `https://wa.me/919173096727?text=${encodeURIComponent(waEnMsg)}`;

  // Map category code to human readable text
  let categoryLabel = 'Water Purifier';
  if (product.category === 'domestic') categoryLabel = 'Domestic RO';
  else if (product.category === 'commercial') categoryLabel = 'Commercial RO';
  else if (product.category === 'spares') categoryLabel = 'Filters & Spares';
...
<head>
  ...
  <title>${product.name} - Shivam Water Solution Morbi</title>
...
<body class="lang-en">
  ...
  <header class="main-header">
    <div class="container header-container">
      <a href="index.html" class="logo-area">
        <img src="assets/logo.webp" alt="Shivam Water Solution Logo" class="header-logo" fetchpriority="high" width="63" height="63">
        <div class="brand-text">
          <span class="brand-name">Shivam Water</span>
      ...
      <nav class="desktop-nav">
        ...
        <a href="index.html#purity" class="nav-link">Why RO?</a>
        <a href="index.html#about" class="nav-link">Why Us</a>
  ...
  <div class="mobile-menu-overlay">
    <div class="mobile-menu">
      <div class="mobile-menu-header">
        <div class="logo-area">
          <img src="assets/logo.webp" alt="Shivam Water Solution Logo" class="header-logo" width="32" height="32" style="height: 32px;">
          <div class="brand-text">
            <span class="brand-name" style="font-size: 0.95rem; font-weight: 800; font-family: var(--font-display); line-height: 1.1;">Shivam Water</span>
      ...
      <div class="mobile-menu-actions">
        <a href="tel:+919173096727" class="btn btn-primary w-full text-center">
          <i data-lucide="phone"></i>
          <span>Call Dilip Bhai</span>
        </a>
        <a href="https://wa.me/919173096727?text=Hi%20Shivam%20Water%20Solution,%20I%20have%20an%20enquiry%20about%20your%20water%20filter%20services." 
           target="_blank" 
           class="btn btn-whatsapp w-full text-center mt-3"
           data-wa-en="Hi Shivam Water Solution, I have an enquiry about your water filter services.">
      ...
      <div class="product-detail-grid">
        ...
        <div class="product-info-section">
          ...
          <div class="action-buttons-detail">
            <a href="https://wa.me/919173096727?text=Hi%20Shivam%20Water%20Solution,%20I%20am%20interested%20in%20a%20price%20quote%20for%20the%20${encodeURIComponent(product.name)}%20water%20purifier%20model." 
               target="_blank" 
               class="btn btn-whatsapp btn-lg w-full justify-center"
               data-wa-en="Hi Shivam Water Solution, I am interested in a price quote for the ${product.name} water purifier model.">
              <svg class="icon-whatsapp-svg" viewBox="0 0 24 24"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L0 24l6.335-1.662c1.746.953 3.71 1.455 5.703 1.456h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
    ...
    <div class="container footer-container">
      <div class="footer-grid">
        ...
        <div class="footer-brand">
          <a href="index.html" class="logo-area">
            <img src="assets/logo_without_bg.webp" alt="Shivam Water Solution Logo" class="footer-logo" loading="lazy" width="48" height="48">
            <div class="brand-text">
              <span class="brand-name">Shivam Water</span>
              <span class="brand-sub">Solution</span>
            </div>
          ...
          <p class="mt-4 brand-desc">
            <span>Providing pure, sweet, and mineral-balanced drinking water to thousands of homes and ceramic factories in Morbi & Rajkot. Quality and service are our priorities.</span>
          </p>
        ...
        <div class="footer-links">
          ...
          <ul class="footer-links-list">
            ...
            <li><a href="index.html#about">Why Us</a></li>
            <li><a href="index.html#faq">FAQs</a></li>
            <li><a href="blogs.html">Water Blogs</a></li>
          </ul>
        </div>
      ...
      <div class="footer-bottom text-center">
        <p class="copyright-text">
          &copy; 2026 Shivam Water Solution. All Rights Reserved. | Designed by <a href="https://shivrajsinh.in" target="_blank" class="designer-link">Shivrajsinh.in</a>
        </p>
      </div>
    </div>
  </footer>
  ...
  <div class="floating-ctas">
    ...
    <a href="https://wa.me/919173096727?text=Hi%20Shivam%20Water%20Solution,%20I%20need%20RO%20servicing%20at%20my%20address." 
       target="_blank" 
       class="floating-btn float-whatsapp" 
       aria-label="WhatsApp Chat Now"
       data-wa-en="Hi Shivam Water Solution, I need RO servicing at my address.">
...
const badgesMap = {
  "aqua-2090": "Premium",
  "alica-pure": "Popular",
  "aqua-touch": "Best Seller",
  "olly-arise": "New Launch",
  "aqua-flip": "Eco-Save",
  "aqua-c3": "Under Sink",
  "aqua-klick": "Elegant",
  "dolphine-kool": "Compact",
  "aqua-era": "Value Choice",
  "hi-flo": "Heavy Duty",
  "lx-series": "Luxury"
};
...
function generateProductsGrid(products) {
  ...
  featuredProducts.forEach((product, index) => {
    ...
    const badgeHTML = badge ? `          <div class="product-badge"><span>${badge}</span></div>\n` : '';
...
${badgeHTML}          <div class="product-img-wrap">
          ...
          <div class="product-info">
            ...
            <div class="card-action-row">
              ...
              <a href="https://wa.me/919173096727?text=Hi%20Shivam%20Water%20Solution,%20I%20am%20interested%20in%20a%20quote%20for%20the%20${encodeURIComponent(product.name)}%20water%20purifier." 
                 target="_blank" 
                 class="btn btn-whatsapp btn-sm" 
                 data-wa-en="Hi Shivam Water Solution, I am interested in a quote for the ${product.name} water purifier.">
